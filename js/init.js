...
(function ($) {
  ...
  var Resumo = {
    ...
    init: function () {
      ...
      /* Custom iframe cursor handling */
      Resumo.iframeCursorEvents();
    },

    iframeCursorEvents: function () {
      const iframes = document.querySelectorAll("iframe"); // Select all iframes

      iframes.forEach((iframe) => {
        // Wait for the iframe to load
        iframe.addEventListener("load", function () {
          // When the mouse enters the iframe
          iframe.addEventListener("mouseenter", function () {
            document.body.classList.add("disable-cursor-effect");
          });

          // When the mouse leaves the iframe
    ...
    cursor: function () {
      ...
      if (myCursor.length) {
        ...
        var n,
          ...
          o = !1;
        var buttons =
          "a, input[type='submit'], .cursor-link, button, .modal_item";
        ...
        // slider mouse enter
        $("body")
          .on("mouseenter", sliders, function () {
